...
#ifndef DevSuccessState_H
#define DevSuccessState_H

#ifdef PRAGMA
#pragma interface "DevSuccessState.h"
#endif
...
class DevSuccessState : public DeviceState
{
public:
	...
	static DevSuccessState& GetStateInstance()
	{
		return _instance;
	}
...
private:
	...
	// {{{USR
	static DevSuccessState _instance;
	// }}}USR
	// }}}RME

public:
	// {{{RME tool 'OT::Cpp' property 'GenerateDefaultConstructor'
	DevSuccessState( void );
	// }}}RME
	// {{{RME tool 'OT::Cpp' property 'GenerateDestructor'
	virtual ~DevSuccessState( void );
	// }}}RME
